                            ...
                            <div class="product-details">
                                ...
                                <div class="details-filter-row details-row-size">
                                    ...
                                    <div class="product-nav product-nav-thumbs">
                                        <a href="#" class="active">
                                            <img src="{{ asset('vendors/molla/assets/images/products/single/1-thumb.jpg') }}"
                                                alt="product desc">
                                        </a>
                                        <a href="#">
                                            <img src="{{ asset('vendors/molla/assets/images/products/single/2-thumb.jpg') }}"
                                                alt="product desc">
                                        </a>
                                    </div><!-- End .product-nav -->
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product product-7 text-center">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('vendors/molla/assets/images/products/product-4.jpg') }}"
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-nav product-nav-thumbs">
                                <a href="#" class="active">
                                    <img src="{{ asset('vendors/molla/assets/images/products/product-4-thumb.jpg') }}"
                                        alt="product desc">
                                </a>
                                <a href="#">
                                    <img src="{{ asset('vendors/molla/assets/images/products/product-4-2-thumb.jpg') }}"
                                        alt="product desc">
                                </a>

                                <a href="#">
                                    <img src="{{ asset('vendors/molla/assets/images/products/product-4-3-thumb.jpg') }}"
                                        alt="product desc">
                                </a>
                            </div><!-- End .product-nav -->
                    ...
                    <div class="product product-7 text-center">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('vendors/molla/assets/images/products/product-6.jpg') }}"
                                    alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-7 text-center">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('vendors/molla/assets/images/products/product-11.jpg') }}"
                                    alt="Product image" class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-nav product-nav-thumbs">
                                <a href="#" class="active">
                                    <img src="{{ asset('vendors/molla/assets/images/products/product-11-thumb.jpg') }}"
                                        alt="product desc">
                                </a>
                                <a href="#">
                                    <img src="{{ asset('vendors/molla/assets/images/products/product-11-2-thumb.jpg') }}"
                                        alt="product desc">
                                </a>

                                <a href="#">
                                    <img src="{{ asset('vendors/molla/assets/images/products/product-11-3-thumb.jpg') }}"
                                        alt="product desc">
                                </a>
                            </div><!-- End .product-nav -->
                        </div><!-- End .product-body -->
                    ...
                    <div class="product product-7 text-center">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('vendors/molla/assets/images/products/product-10.jpg') }}"
                                    alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-7 text-center">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('vendors/molla/assets/images/products/product-7.jpg') }}"
                                    alt="Product image" class="product-image">
                            </a>
