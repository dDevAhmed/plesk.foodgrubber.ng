                            ...
                            <ul class="nav nav-dashboard flex-column mb-3 mb-md-0" role="tablist">
                                ...
                                <li class="nav-item">
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <input type="hidden" name="redirect_to" value="/marketplace">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab-dashboard" role="tabpanel"
                                    ...
                                    @if (Auth::check())
                                        <p>Hello <span class="font-weight-normal text-dark">{{ $customer->name }},</span>
                                            <br>
                                            From your account dashboard you can view your <a href="#tab-orders"
                                                class="tab-trigger-link text-secondary">recent orders</a>, manage your <a
                                                href="#tab-address" class="tab-trigger-link text-secondary">shipping and
                                                billing
                                                addresses</a>,
                                            and <a href="#tab-account" class="tab-trigger-link text-secondary">edit your
