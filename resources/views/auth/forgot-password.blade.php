...
<head>
    ...
    <title>Forgot Password | Foodgrubber</title>
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-tab">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="signin-tab-2" data-toggle="tab" href="javascript:void(0)"
                                        role="tab" aria-controls="signin-2" aria-selected="false">Forgot Password?</a>
                                </li>
                            </ul>
                            <p class="mt-2">Enter your email and we'll send you instructions to reset your password</p>
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="signin-2" role="tabpanel"
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <a href="{{ route('login') }}" class="forgot-link text-secondary" style="display:flex; justify-content:center; gap: 5px;"><i class="icon-long-arrow-left"></i> Back to login page</a>
                                    </form>
                                </div><!-- .End .tab-pane -->
                            </div><!-- End .tab-content -->
                        </div><!-- End .form-tab -->
